...
var Login = React.createClass({displayName: "Login",
    getInitialState: function () {
        ...
        return temp;//Tools.extend(temp,{telephone:"",password:""});
    },
    ...
    render: function () {
        ...
        return (
            React.createElement("form", {onSubmit: this.handleSubmitStart, method: "get", className: "login_window"}, 
                ...
                React.createElement(Tel, {sendToParent: this.sendToParent}), 
                nameCom, 
                React.createElement(Password, {sendToParent: this.sendToParent}), 
