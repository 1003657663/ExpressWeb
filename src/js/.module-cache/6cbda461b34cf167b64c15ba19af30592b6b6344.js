    ...
    render: function () {
        ...
        return (
            React.createElement("form", {method: "get", className: "login_window"}, 
                ...
                React.createElement("div", null, React.createElement("input", {type: "submit", className: "login_submit", onClick: this.handleSubmitClick, onSubmit: this.handleSubmitClick, defaultValue: "提交"}))
            )
        );
    }
});