...
var EmployeeManagerComponent = React.createClass({displayName: "EmployeeManagerComponent",
    ...
    getEmployeeSuccess: function (data) {
        if(this.isMounted()){
            this.props.onDoClick(null,null,[React.createElement(EmployeeListComponent, {data: data})]);
        }
    },
    addEmployee: function () {
        //跳转到注册页面直接注册员工
        ReactDOM.render(
            React.createElement(Login, {isLogin: "false", key: "noLogin", siteID: this.props.siteID}),
...
var EmployeeListComponent = React.createClass({displayName: "EmployeeListComponent",
    ...
    onLiClick: function (e) {
        ...
        //跳转到注册页面直接注册员工
        ReactDOM.render(
            React.createElement(Login, {isLogin: "false", isUpdate: true, key: "noLogin", employee: employee, siteID: this.props.siteID}),
            document.getElementById("login_container")
        );
    },
    render: function () {
                ...
                this.state.data.map(function (data, index) {
                    return (
                        React.createElement("li", {key: "li"+index, "data-index": index, onClick: this.onLiClick}, 
                            ...
                            React.createElement("img", {"data-index": index, onClick: this.onDelClick, key: "delimg", src: "../images/manager/delete.png"})
                        )
                    )
                }.bind(this))
            )
